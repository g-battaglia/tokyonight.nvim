local ts = require("tokyonightowl.treesitter")
...
function M.invert_color(color)
  local hsluv = require("tokyonightowl.hsluv")
  if color ~= "NONE" then
...
function M.onColorScheme()
  vim.cmd([[autocmd! tokyonightowl]])
  vim.cmd([[augroup! tokyonightowl]])
end
...
function M.autocmds(config)
  vim.cmd([[augroup tokyonightowl]])
  vim.cmd([[  autocmd!]])
  vim.cmd([[  autocmd ColorSchemePre * lua require("tokyonightowl.util").onColorScheme()]])
...
function M.load(theme)
  ...
  vim.g.colors_name = "tokyonightowl"
